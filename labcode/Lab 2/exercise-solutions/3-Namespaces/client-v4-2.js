...
// NEW ADDITION to reference the paragraph to display 
// total count of all connected users
...
connectBtn.addEventListener('click', () => {
  ...
  // NEW ADDITION 
  // Update with the total number of users 
  // online
  socket.on('totalUsersUpdate', ({ total }) => {
    totalUsersDisplay.textContent = `Total users online: ${total}`;
  });
